...
def solve(data):
    # Store in the Set , Where all duplicate will remove Basically Extract the unique scores and sort them
    ...
    for result in second_lowest_students:
        print(result)
